...
// Check if the user is logged in, if yes go to continue otherwise redirect to index page
...
<header>
	...
	<ul class="nav">
		...
		<li><a>Messaging<span class="badge top">10</span></a></li>
		<li><a href="#">                   
...
<ul class="meta list list-unstyled">
    <li class="name" style="text-transform: uppercase;"><?php echo $result['fullnames']; ?>
        <br><label class="label label-info">Starter</label>
    </li>
</a>
    <li class="btn btn-primary"><i class="fa fa-users"></i> <a style="color: white; width: 160px;" href="viewallmembers.php"> MEMBERS </a></li>
</ul>
</ul>
</div>
<!--/.sidebar-->
...
if (mysqli_num_rows($query2) < 1) { ?>
    <h2>No Posts Found matching your search "<?php echo $searchdata; ?>"..</h2>
<?php 
} else {
...
<div class="media stream" style="background-color: #dfdfdf; margin-bottom: 20px;">
...
?>
	...
	<div class="media-body">
		...
		<div class="stream-options">
			...
			$query6 = mysqli_query($link,"SELECT * FROM comments where post_id = $thispost_id ORDER BY created_at asc limit 2");
			if (!empty($query6)) {
            ...
            if ($rows > 2) { ?>
                <a style="margin-left: 100px; " href="viewpostdetails.php?postid=<?php echo $result2['id']; ?>"> View all Comments </a>
            <?php } 
            ?>
    		...
    		<div class="row-fluid <?php echo (!empty($postcomment_data_err)) ? 'has-error' : ''; ?>" >
						<textarea class="span12" name="usercomment" style="height: 50px; resize: none;" placeholder="Drop your comment.."></textarea>
						...
						<input type="submit" name="postcomment" value="Comment" class="btn btn-success">			
			</div>
			</form>
			</div>
...
<div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        <input type="submit" name="editthis-post" value="Save">
