...
<div class="main">
  <div id="home">
  <h2>All Intellectland community admins</h2>
...
$query12 = mysqli_query($link,"SELECT * FROM users WHERE user_level = 1 order by id DESC");
...
<td><?php echo $result13['username']; ?></td>
<td><?php echo $result13['firstname']; ?></td>
<td><?php echo $result13['lastname']; ?></td>
<td><?php echo $result13['email']; ?></a></td>
<td><?php echo $result13['phone']; ?></td>
<td><?php echo $result13['location']; ?></td>
