...
<div class="main">
  <div id="home">
  <h2>Intellectland community Suspended members</h2>
...
<thead style="background-color: #006669;color: #fff;">
  ...
  <th>Location</th>
  <th>Image</th>
  <th colspan="2" style="background-color: tomato;text-align: center;">Action</th>
</tr>
</thead>
<!-- Get all system users -->
<?php
$loggedinuser = $result11['id'];
$query12 = mysqli_query($link,"SELECT * FROM users WHERE verified = 1 AND suspended = 1 order by id DESC");
...
<tbody>
  <tr>
<th>
  <?php if ($result12['user_level']==1) { ?>
    <a href="user-profile.php?userprofile=<?php echo $result13['id']; ?>"><?php echo $result13['fullnames']." "."<font color=red size=1>ADMIN</font>"; ?></a>
  <?php } else { ?>
    <a href="user-profile.php?userprofile=<?php echo $result13['id']; ?>"><?php echo $result13['fullnames']; ?></a>
  <?php }
  ?>
